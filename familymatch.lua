...
local cols = {"babypig.png", "chick.png", "babysheep.png", "babycow.png"}
local anims = {"pigs.png", "hens.png","sheepfam.png","cowfam.png"}
...
if group == "" then
	if text == "pigs.png" then
		group = "babypig.png"
	elseif text == "hens.png" then
		group = "chick.png"
	elseif text == "sheepfam.png" then
		group = "babysheep.png"
	elseif text == "cowfam.png" then
		group = "babycow.png"
	end
